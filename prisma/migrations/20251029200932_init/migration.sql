...
-- CreateIndex
CREATE UNIQUE INDEX "Finance_studentId_key" ON "Finance"("studentId");
...
-- AddForeignKey
ALTER TABLE "Finance" ADD CONSTRAINT "Finance_studentId_fkey" FOREIGN KEY ("studentId") REFERENCES "Student"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
